-- Pegá esto en Railway → MySQL → pestaña "Query" o "Console"
-- Borra TODAS las tablas del schema actual y crea las de LupoEnvios.
...
-- Después de ejecutar este SQL, corré en el servicio backend:
-- npm run db:reset:prod
-- (solo para cargar usuarios y pedidos demo; o insertalos manualmente)
