-- =============================================================================
-- Posta / LupoEnvios — Schema manual (Railway MySQL)
-- =============================================================================
-- Normalmente NO hace falta ejecutar esto a mano: al deployar el backend, si la
-- base está vacía, se corre schema.sql automáticamente (ensureDatabaseSchema).
--
-- Usá este archivo solo si querés crear tablas manualmente en la consola MySQL.
-- Es una copia de schema.sql con comentarios para Railway.
-- =============================================================================
