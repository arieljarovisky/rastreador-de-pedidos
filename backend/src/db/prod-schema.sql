-- =============================================================================
-- LupoEnvios — esquema idéntico a producción (Railway)
-- Ejecutar en MySQL 8+ (Railway → Query, o cliente local).
--
-- Opción A: base nueva
--   Descomentá CREATE DATABASE / USE y cambiá el nombre si querés.
--
-- Opción B: reemplazar tablas en una base existente (ej. railway)
--   Comentá CREATE DATABASE y poné USE railway;
-- =============================================================================

-- CREATE DATABASE IF NOT EXISTS `lupo_tracking` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
-- USE `lupo_tracking`;
...
-- Tablas legacy de otros proyectos (si existían en Railway)
DROP TABLE IF EXISTS `fantasy_teams`;
DROP TABLE IF EXISTS `matchday_scores`;
DROP TABLE IF EXISTS `matchday_squads`;
